...
namespace Trainers\Http\Controllers;

use Illuminate\Http\Request;
use Trainers\Trainer;
use Trainers\Http\Requests\StoreTrainerRequest;
...
class TrainerController extends Controller
{
    ...
    public function update(Request $request, Trainer $trainer)
    {
        ...
        $trainer->save();
        return redirect()->route('trainers.show',[$trainer])->with('status','Datos modificados correctamente');
    }
